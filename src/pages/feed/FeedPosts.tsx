...
export const FeedPosts = (): React.JSX.Element => {
   const { isLoading, userFeed } = useFetchFeed();
         ...
         {userFeed.length === 0 && !isLoading && (
            <div className="flex flex-col items-center justify-center h-[50vh] mx-3">
               ...
               >
                  ...
                  >
                     No Posts matching your interests. Go to{' '}
                     <Link className="text-pink-600 hover:underline" to={`/settings`}>
                        {' '}
                        Settings{' '}
                     </Link>
                     and add some interests or
                     <Link to="/explore" className="text-pink-600 hover:underline">
                        {' '}
                        Explore posts
                     </Link>
                  </Typography>
